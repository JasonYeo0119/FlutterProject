...
class PremiumProfile extends StatefulWidget {
  ...
  @override
  State<PremiumProfile> createState() => _PremiumProfileState();
}

class _PremiumProfileState extends State<PremiumProfile> {
  User? user;
  late Query userRef;
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: Color(0xFF294C37), // Adjust the color as needed
                    boxShadow: [
                      BoxShadow(
                    ...
                    Row(
                      ...
                      children: [
                        Column(
                          children: [
                            Text(
                              'Click To Extend Your Premium Period!',
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                color: Color(0xFF4F462E),
                                fontSize: 16,
